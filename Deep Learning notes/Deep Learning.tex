...
\begin{itemize}
    ...
    \item Top-right region: $\max(2, 1, 0, 2) = 2$.
    \item Bottom-left region: $\max(6, 5, 2, 1) = 6$.
    \item Bottom-right region: $\max(0, 3, 3, 3) = 3$.
\end{itemize}
...
Pooling layers are essential components of ConvNets for reducing representation size and computational cost. They do not involve learning parameters and are defined entirely by their hyperparameters. Next, we will discuss fully connected layers and their role in ConvNets.
